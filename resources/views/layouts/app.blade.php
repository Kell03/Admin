                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        ...
                        <ul class="nav nav-treeview">
                           <li class="nav-item">
                                <a href="{{route('usuarios.index')}}" class="{{ Request::path() === 'usuarios' ? 'nav-link active' : 'nav-link' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{route('dueños.index')}}"
                                    class="{{ Request::path() === 'dueños' ? 'nav-link active' : 'nav-link' }}">
                                    <i class="nav-icon fas fa-user-circle   "></i>
                                    <p>
                                           Dueños
                                        <?php $dueños_count = DB::table('dueños')->count(); ?>
                                        <span class="right badge badge-danger">{{ $dueños_count ?? '0' }}</span>
                                    </p>
                                </a>
                            ...
                            <a href="{{route('cedes.index')}}" class="{{ Request::path() === 'cedesss' ? 'nav-link active' 
                            : 'nav-link' }}"><i class="nav-icon fas fa-warehouse    "></i><p> Centros Dist
                                        <?php $cedes_count = DB::table('cedes')->count(); ?>
                                        <span class="right badge badge-danger">{{ $cedes_count ?? '0' }}</span>
                            </p>
                                </a>
                            </li>
                             ...
                             <li class="nav-item">
                                <a href="{{route('choferes.index')}}"
                                    class="{{ Request::path() === 'choferes' ? 'nav-link active' : 'nav-link' }}">
                                    <i class="nav-icon fas fa-users"></i>
                                    <p>
                                        Choferes
                                        <?php $choferes_count = DB::table('choferes')->count(); ?>
                                        <span class="right badge badge-danger">{{ $choferes_count ?? '0' }}</span>
                                    </p>
                                </a>
                            ...
                            <a href="{{route('gandolas.index')}}" class="{{ Request::path() === 'gandolas' ? 'nav-link active' 
                            : 'nav-link' }}"><i class="nav-icon fas fa-truck "></i><p> Gandolas
                                        <?php $gandolas_count = DB::table('gandolas')->count(); ?>
                                        <span class="right badge badge-danger">{{ $gandolas_count ?? '0' }}</span>
                            </p>
                                </a>
                            </li>
 ...
 <ul class="nav nav-treeview">
                             ...
                             <li class="nav-item">
                                <a href="{{route('guias.index')}}"
                                    class="{{ Request::path() === 'guias' ? 'nav-link active' : 'nav-link' }}">
